...
lib = "-lglfw3dll -lglew32s -lopengl32 -lgdi32 -lwinhttp"
...
def main():
    ...
    # compile user scripts and imgui (C++17 for std::optional, threads)
    subprocess.call(f"g++ -std=c++17 -c assets/scripts/main.cpp {imgui_src} {includes}")
