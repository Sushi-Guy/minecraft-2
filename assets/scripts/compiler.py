...
lib = "-lglfw3dll -lglew32s -lopengl32 -lgdi32 -lnakama-sdk"
preprocessor = "-DGLEW_STATIC"

def main():
    # include paths for generic project and imgui
    includes = f"-I {include_dir} -I dependencies/imgui -I dependencies/imgui/backends -I dependencies/nakama-sdk/win-x64-Debug/include"
    ...
    subprocess.call(f"g++ *.o -o {file_name} -L {lib_dir} -L dependencies/nakama-sdk/win-x64-Debug/lib {lib}")
    shutil.copy("dependencies/nakama-sdk/win-x64-Debug/lib/nakama-sdk.dll", ".")
